...
<div class="container-fluid bg-dark-subtle text-light-emphasis text-center py-3">
    <h1>I servizi per la clientela</h1>
</div>
      ...
      <div class="row">
        ...
        <div class="col-12 d-flex flex-wrap my-3 mx-1">
          <div class="card mx-auto" style="width: 35rem;">
            <img src="{{$service['img']}}" class="card-img-top" alt="{{$service['tipologia']}}">
            <div class="card-body">
              <h5 class="card-title">{{$service['tipologia']}}</h5>
              <h6 class="card-subtitle mb-2 text-body-secondary">{{$service['descrizione']}}</h6>
            </div>
          </div>
        </div>
        @endforeach
